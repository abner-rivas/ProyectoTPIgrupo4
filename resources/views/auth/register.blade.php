            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            <label for="name" class="col-md-4 col-form-label text-md-end">{{ __('Rubro') }}</label>

                            <div class="col-md-6">
                                <input id="rubro" type="text" class="form-control @error('rubro') is-invalid @enderror" name="rubro" value="{{ old('rubro') }}" required autocomplete="rubro" autofocus>
